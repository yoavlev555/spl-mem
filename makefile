...
compile: src/main.cpp src/Auxiliary.cpp src/Settlement.cpp src/Simulation.cpp src/FacilityType.cpp
...
link: bin/main.o bin/Settlement.o bin/Auxiliary.o bin/Simulation.o bin/FacilityType.o
	@echo "Linking object files..."
	g++ -o bin/main bin/main.o bin/Settlement.o bin/Auxiliary.o bin/Simulation.o bin/FacilityType.o
